...
- [x] 11. 编写实践指南 - 自定义工具
  - [x] 11.1 创建 `docs/guides/custom-tools.md`
...
- [-] 16. 编写高级主题文档 - 消息流处理
  - [x] 16.1 创建 `docs/advanced/message-streaming.md`
    - 说明流式处理的设计原理
...
- [x] 17. 编写高级主题文档 - 异步工具执行
  - [x] 17.1 创建 `docs/advanced/async-tool-execution.md`
    - 说明工具并发执行机制
...
- [x] 18. 编写贡献指南
  - [x] 18.1 创建 `docs/contributing.md`
    - 编写开发环境设置说明
    - 说明如何克隆仓库和安装依赖
